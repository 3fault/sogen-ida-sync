...
if (NOT EXISTS "${IDASDK_PRO_H}")
    message(FATAL_ERROR "IDA SDK folder '${IDASDK}' seems invalid ('${IDASDK_PRO_H}')")
endif()
...
macro(generate)
    if (DEFINED IDASDK)
        include(${CMAKE_SOURCE_DIR}/cmake/ida/addons.cmake)
    elseif (DEFINED ENV{IDASDK})
        include(${CMAKE_SOURCE_DIR}/cmake/ida/addons.cmake)
    else()
        message(FATAL_ERROR "IDA SDK folder not specified via the -D switch or the environment variable 'IDASDK'")
...
function(disable_ida_warnings target)
    if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
        # error C4996: 'std::is_pod<T>': warning STL4025: std::is_pod and std::is_pod_v are deprecated in C++20.
        target_compile_options(${target} PRIVATE "/wd4267" "/wd4244" "/wd4018" "/wd4146" "/wd4996")
    endif()
endfunction()
